...
:: FiveM
echo Clearing FiveM Server Cache...
...
echo Clearing More Temp Traces...
...
echo Clearning Used Driver Files
...
del /f /s /q "%APPDATA%\Microsoft\Edge\User Data\Default\Cache\*"
del /f /s /q "%APPDATA%\Google\Chrome\User Data\Default\Cache\*"
del /f /s /q "%APPDATA%\Mozilla\Firefox\Profiles\*.default-release\cache2\*"
...
del /f /s /q "%LocalAppData%\Microsoft\Windows\Recent\*"

del /f /s /q "%LocalAppData%\Opera Software\Opera Stable\Cache\*"
...
echo All specified temporary files, logs, and traces have been deleted.
pause
